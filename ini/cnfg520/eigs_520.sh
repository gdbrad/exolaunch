...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs520.out
...
log=$BASE_DIR/log/eigs/eigs_520.log
in=$BASE_DIR/xml/eigs/eigs_520.ini.xml
out=$BASE_DIR/out/eigs/eigs_520.out.xml
