...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs510.out
...
log=$BASE_DIR/log/eigs/eigs_510.log
in=$BASE_DIR/xml/eigs/eigs_510.ini.xml
out=$BASE_DIR/out/eigs/eigs_510.out.xml
