...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs10.out
...
log=$BASE_DIR/log/eigs/eigs_10.log
in=$BASE_DIR/xml/eigs/eigs_10.ini.xml
out=$BASE_DIR/out/eigs/eigs_10.out.xml
