...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs470.out
...
log=$BASE_DIR/log/eigs/eigs_470.log
in=$BASE_DIR/xml/eigs/eigs_470.ini.xml
out=$BASE_DIR/out/eigs/eigs_470.out.xml
