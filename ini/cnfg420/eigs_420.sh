...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs420.out
...
log=$BASE_DIR/log/eigs/eigs_420.log
in=$BASE_DIR/xml/eigs/eigs_420.ini.xml
out=$BASE_DIR/out/eigs/eigs_420.out.xml
