...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs900.out
...
log=$BASE_DIR/log/eigs/eigs_900.log
in=$BASE_DIR/xml/eigs/eigs_900.ini.xml
out=$BASE_DIR/out/eigs/eigs_900.out.xml
