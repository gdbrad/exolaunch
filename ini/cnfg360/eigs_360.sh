...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs360.out
...
log=$BASE_DIR/log/eigs/eigs_360.log
in=$BASE_DIR/xml/eigs/eigs_360.ini.xml
out=$BASE_DIR/out/eigs/eigs_360.out.xml
