...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs380.out
...
log=$BASE_DIR/log/eigs/eigs_380.log
in=$BASE_DIR/xml/eigs/eigs_380.ini.xml
out=$BASE_DIR/out/eigs/eigs_380.out.xml
