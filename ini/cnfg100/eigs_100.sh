...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs100.out
...
log=$BASE_DIR/log/eigs/eigs_100.log
in=$BASE_DIR/xml/eigs/eigs_100.ini.xml
out=$BASE_DIR/out/eigs/eigs_100.out.xml
