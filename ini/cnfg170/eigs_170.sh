...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs170.out
...
log=$BASE_DIR/log/eigs/eigs_170.log
in=$BASE_DIR/xml/eigs/eigs_170.ini.xml
out=$BASE_DIR/out/eigs/eigs_170.out.xml
