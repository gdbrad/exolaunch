...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs740.out
...
log=$BASE_DIR/log/eigs/eigs_740.log
in=$BASE_DIR/xml/eigs/eigs_740.ini.xml
out=$BASE_DIR/out/eigs/eigs_740.out.xml
