...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs880.out
...
log=$BASE_DIR/log/eigs/eigs_880.log
in=$BASE_DIR/xml/eigs/eigs_880.ini.xml
out=$BASE_DIR/out/eigs/eigs_880.out.xml
