...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs610.out
...
log=$BASE_DIR/log/eigs/eigs_610.log
in=$BASE_DIR/xml/eigs/eigs_610.ini.xml
out=$BASE_DIR/out/eigs/eigs_610.out.xml
