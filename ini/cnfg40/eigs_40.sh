...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs40.out
...
log=$BASE_DIR/log/eigs/eigs_40.log
in=$BASE_DIR/xml/eigs/eigs_40.ini.xml
out=$BASE_DIR/out/eigs/eigs_40.out.xml
