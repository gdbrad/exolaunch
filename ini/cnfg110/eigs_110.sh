...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs110.out
...
log=$BASE_DIR/log/eigs/eigs_110.log
in=$BASE_DIR/xml/eigs/eigs_110.ini.xml
out=$BASE_DIR/out/eigs/eigs_110.out.xml
