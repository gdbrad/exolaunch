...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs80.out
...
log=$BASE_DIR/log/eigs/eigs_80.log
in=$BASE_DIR/xml/eigs/eigs_80.ini.xml
out=$BASE_DIR/out/eigs/eigs_80.out.xml
