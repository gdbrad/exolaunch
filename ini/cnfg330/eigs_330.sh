...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs330.out
...
log=$BASE_DIR/log/eigs/eigs_330.log
in=$BASE_DIR/xml/eigs/eigs_330.ini.xml
out=$BASE_DIR/out/eigs/eigs_330.out.xml
