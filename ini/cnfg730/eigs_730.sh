...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs730.out
...
log=$BASE_DIR/log/eigs/eigs_730.log
in=$BASE_DIR/xml/eigs/eigs_730.ini.xml
out=$BASE_DIR/out/eigs/eigs_730.out.xml
