...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs20.out
...
log=$BASE_DIR/log/eigs/eigs_20.log
in=$BASE_DIR/xml/eigs/eigs_20.ini.xml
out=$BASE_DIR/out/eigs/eigs_20.out.xml
