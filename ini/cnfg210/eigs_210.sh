...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs210.out
...
log=$BASE_DIR/log/eigs/eigs_210.log
in=$BASE_DIR/xml/eigs/eigs_210.ini.xml
out=$BASE_DIR/out/eigs/eigs_210.out.xml
