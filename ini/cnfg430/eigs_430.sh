...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs430.out
...
log=$BASE_DIR/log/eigs/eigs_430.log
in=$BASE_DIR/xml/eigs/eigs_430.ini.xml
out=$BASE_DIR/out/eigs/eigs_430.out.xml
