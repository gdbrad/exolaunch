...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs710.out
...
log=$BASE_DIR/log/eigs/eigs_710.log
in=$BASE_DIR/xml/eigs/eigs_710.ini.xml
out=$BASE_DIR/out/eigs/eigs_710.out.xml
