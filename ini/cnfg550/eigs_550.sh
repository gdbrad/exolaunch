...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs550.out
...
log=$BASE_DIR/log/eigs/eigs_550.log
in=$BASE_DIR/xml/eigs/eigs_550.ini.xml
out=$BASE_DIR/out/eigs/eigs_550.out.xml
