...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs140.out
...
log=$BASE_DIR/log/eigs/eigs_140.log
in=$BASE_DIR/xml/eigs/eigs_140.ini.xml
out=$BASE_DIR/out/eigs/eigs_140.out.xml
