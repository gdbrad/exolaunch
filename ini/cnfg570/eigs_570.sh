...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs570.out
...
log=$BASE_DIR/log/eigs/eigs_570.log
in=$BASE_DIR/xml/eigs/eigs_570.ini.xml
out=$BASE_DIR/out/eigs/eigs_570.out.xml
