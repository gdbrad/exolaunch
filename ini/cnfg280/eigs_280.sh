...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs280.out
...
log=$BASE_DIR/log/eigs/eigs_280.log
in=$BASE_DIR/xml/eigs/eigs_280.ini.xml
out=$BASE_DIR/out/eigs/eigs_280.out.xml
