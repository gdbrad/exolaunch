...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs660.out
...
log=$BASE_DIR/log/eigs/eigs_660.log
in=$BASE_DIR/xml/eigs/eigs_660.ini.xml
out=$BASE_DIR/out/eigs/eigs_660.out.xml
