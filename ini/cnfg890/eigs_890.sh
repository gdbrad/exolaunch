...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs890.out
...
log=$BASE_DIR/log/eigs/eigs_890.log
in=$BASE_DIR/xml/eigs/eigs_890.ini.xml
out=$BASE_DIR/out/eigs/eigs_890.out.xml
