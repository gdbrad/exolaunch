...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs930.out
...
log=$BASE_DIR/log/eigs/eigs_930.log
in=$BASE_DIR/xml/eigs/eigs_930.ini.xml
out=$BASE_DIR/out/eigs/eigs_930.out.xml
