...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs750.out
...
log=$BASE_DIR/log/eigs/eigs_750.log
in=$BASE_DIR/xml/eigs/eigs_750.ini.xml
out=$BASE_DIR/out/eigs/eigs_750.out.xml
