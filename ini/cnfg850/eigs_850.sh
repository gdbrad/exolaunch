...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs850.out
...
log=$BASE_DIR/log/eigs/eigs_850.log
in=$BASE_DIR/xml/eigs/eigs_850.ini.xml
out=$BASE_DIR/out/eigs/eigs_850.out.xml
