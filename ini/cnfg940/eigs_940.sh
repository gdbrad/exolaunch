...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs940.out
...
log=$BASE_DIR/log/eigs/eigs_940.log
in=$BASE_DIR/xml/eigs/eigs_940.ini.xml
out=$BASE_DIR/out/eigs/eigs_940.out.xml
