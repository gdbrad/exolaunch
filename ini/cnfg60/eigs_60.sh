...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs60.out
...
log=$BASE_DIR/log/eigs/eigs_60.log
in=$BASE_DIR/xml/eigs/eigs_60.ini.xml
out=$BASE_DIR/out/eigs/eigs_60.out.xml
