...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs250.out
...
log=$BASE_DIR/log/eigs/eigs_250.log
in=$BASE_DIR/xml/eigs/eigs_250.ini.xml
out=$BASE_DIR/out/eigs/eigs_250.out.xml
