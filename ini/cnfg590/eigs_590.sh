...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs590.out
...
log=$BASE_DIR/log/eigs/eigs_590.log
in=$BASE_DIR/xml/eigs/eigs_590.ini.xml
out=$BASE_DIR/out/eigs/eigs_590.out.xml
