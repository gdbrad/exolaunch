...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs30.out
...
log=$BASE_DIR/log/eigs/eigs_30.log
in=$BASE_DIR/xml/eigs/eigs_30.ini.xml
out=$BASE_DIR/out/eigs/eigs_30.out.xml
