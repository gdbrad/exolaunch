...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs650.out
...
log=$BASE_DIR/log/eigs/eigs_650.log
in=$BASE_DIR/xml/eigs/eigs_650.ini.xml
out=$BASE_DIR/out/eigs/eigs_650.out.xml
