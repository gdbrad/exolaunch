...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs450.out
...
log=$BASE_DIR/log/eigs/eigs_450.log
in=$BASE_DIR/xml/eigs/eigs_450.ini.xml
out=$BASE_DIR/out/eigs/eigs_450.out.xml
