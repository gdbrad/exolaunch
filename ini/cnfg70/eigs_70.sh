...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs70.out
...
log=$BASE_DIR/log/eigs/eigs_70.log
in=$BASE_DIR/xml/eigs/eigs_70.ini.xml
out=$BASE_DIR/out/eigs/eigs_70.out.xml
