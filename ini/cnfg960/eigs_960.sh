...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs960.out
...
log=$BASE_DIR/log/eigs/eigs_960.log
in=$BASE_DIR/xml/eigs/eigs_960.ini.xml
out=$BASE_DIR/out/eigs/eigs_960.out.xml
