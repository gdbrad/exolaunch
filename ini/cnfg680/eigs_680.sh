...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs680.out
...
log=$BASE_DIR/log/eigs/eigs_680.log
in=$BASE_DIR/xml/eigs/eigs_680.ini.xml
out=$BASE_DIR/out/eigs/eigs_680.out.xml
