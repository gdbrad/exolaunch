...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs720.out
...
log=$BASE_DIR/log/eigs/eigs_720.log
in=$BASE_DIR/xml/eigs/eigs_720.ini.xml
out=$BASE_DIR/out/eigs/eigs_720.out.xml
