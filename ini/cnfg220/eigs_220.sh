...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs220.out
...
log=$BASE_DIR/log/eigs/eigs_220.log
in=$BASE_DIR/xml/eigs/eigs_220.ini.xml
out=$BASE_DIR/out/eigs/eigs_220.out.xml
