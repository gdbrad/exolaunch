...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs370.out
...
log=$BASE_DIR/log/eigs/eigs_370.log
in=$BASE_DIR/xml/eigs/eigs_370.ini.xml
out=$BASE_DIR/out/eigs/eigs_370.out.xml
