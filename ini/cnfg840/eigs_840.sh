...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs840.out
...
log=$BASE_DIR/log/eigs/eigs_840.log
in=$BASE_DIR/xml/eigs/eigs_840.ini.xml
out=$BASE_DIR/out/eigs/eigs_840.out.xml
