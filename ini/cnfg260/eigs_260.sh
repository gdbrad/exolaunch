...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs260.out
...
log=$BASE_DIR/log/eigs/eigs_260.log
in=$BASE_DIR/xml/eigs/eigs_260.ini.xml
out=$BASE_DIR/out/eigs/eigs_260.out.xml
