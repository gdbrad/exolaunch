...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs580.out
...
log=$BASE_DIR/log/eigs/eigs_580.log
in=$BASE_DIR/xml/eigs/eigs_580.ini.xml
out=$BASE_DIR/out/eigs/eigs_580.out.xml
