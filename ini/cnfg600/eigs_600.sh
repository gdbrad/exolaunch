...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs600.out
...
log=$BASE_DIR/log/eigs/eigs_600.log
in=$BASE_DIR/xml/eigs/eigs_600.ini.xml
out=$BASE_DIR/out/eigs/eigs_600.out.xml
