...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs970.out
...
log=$BASE_DIR/log/eigs/eigs_970.log
in=$BASE_DIR/xml/eigs/eigs_970.ini.xml
out=$BASE_DIR/out/eigs/eigs_970.out.xml
