...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs90.out
...
log=$BASE_DIR/log/eigs/eigs_90.log
in=$BASE_DIR/xml/eigs/eigs_90.ini.xml
out=$BASE_DIR/out/eigs/eigs_90.out.xml
