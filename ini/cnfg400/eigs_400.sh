...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs400.out
...
log=$BASE_DIR/log/eigs/eigs_400.log
in=$BASE_DIR/xml/eigs/eigs_400.ini.xml
out=$BASE_DIR/out/eigs/eigs_400.out.xml
