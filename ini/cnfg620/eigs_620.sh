...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs620.out
...
log=$BASE_DIR/log/eigs/eigs_620.log
in=$BASE_DIR/xml/eigs/eigs_620.ini.xml
out=$BASE_DIR/out/eigs/eigs_620.out.xml
