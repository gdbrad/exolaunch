...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs440.out
...
log=$BASE_DIR/log/eigs/eigs_440.log
in=$BASE_DIR/xml/eigs/eigs_440.ini.xml
out=$BASE_DIR/out/eigs/eigs_440.out.xml
