...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs390.out
...
log=$BASE_DIR/log/eigs/eigs_390.log
in=$BASE_DIR/xml/eigs/eigs_390.ini.xml
out=$BASE_DIR/out/eigs/eigs_390.out.xml
