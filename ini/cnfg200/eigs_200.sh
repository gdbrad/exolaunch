...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs200.out
...
log=$BASE_DIR/log/eigs/eigs_200.log
in=$BASE_DIR/xml/eigs/eigs_200.ini.xml
out=$BASE_DIR/out/eigs/eigs_200.out.xml
