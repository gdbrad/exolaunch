...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs310.out
...
log=$BASE_DIR/log/eigs/eigs_310.log
in=$BASE_DIR/xml/eigs/eigs_310.ini.xml
out=$BASE_DIR/out/eigs/eigs_310.out.xml
