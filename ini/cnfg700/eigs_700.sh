...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs700.out
...
log=$BASE_DIR/log/eigs/eigs_700.log
in=$BASE_DIR/xml/eigs/eigs_700.ini.xml
out=$BASE_DIR/out/eigs/eigs_700.out.xml
