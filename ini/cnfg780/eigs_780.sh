...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs780.out
...
log=$BASE_DIR/log/eigs/eigs_780.log
in=$BASE_DIR/xml/eigs/eigs_780.ini.xml
out=$BASE_DIR/out/eigs/eigs_780.out.xml
