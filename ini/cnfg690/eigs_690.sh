...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs690.out
...
log=$BASE_DIR/log/eigs/eigs_690.log
in=$BASE_DIR/xml/eigs/eigs_690.ini.xml
out=$BASE_DIR/out/eigs/eigs_690.out.xml
