...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs50.out
...
log=$BASE_DIR/log/eigs/eigs_50.log
in=$BASE_DIR/xml/eigs/eigs_50.ini.xml
out=$BASE_DIR/out/eigs/eigs_50.out.xml
