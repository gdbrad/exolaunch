...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs320.out
...
log=$BASE_DIR/log/eigs/eigs_320.log
in=$BASE_DIR/xml/eigs/eigs_320.ini.xml
out=$BASE_DIR/out/eigs/eigs_320.out.xml
