...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs630.out
...
log=$BASE_DIR/log/eigs/eigs_630.log
in=$BASE_DIR/xml/eigs/eigs_630.ini.xml
out=$BASE_DIR/out/eigs/eigs_630.out.xml
