...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs480.out
...
log=$BASE_DIR/log/eigs/eigs_480.log
in=$BASE_DIR/xml/eigs/eigs_480.ini.xml
out=$BASE_DIR/out/eigs/eigs_480.out.xml
