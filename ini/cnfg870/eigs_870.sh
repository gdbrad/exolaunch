...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs870.out
...
log=$BASE_DIR/log/eigs/eigs_870.log
in=$BASE_DIR/xml/eigs/eigs_870.ini.xml
out=$BASE_DIR/out/eigs/eigs_870.out.xml
