...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs290.out
...
log=$BASE_DIR/log/eigs/eigs_290.log
in=$BASE_DIR/xml/eigs/eigs_290.ini.xml
out=$BASE_DIR/out/eigs/eigs_290.out.xml
