...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs990.out
...
log=$BASE_DIR/log/eigs/eigs_990.log
in=$BASE_DIR/xml/eigs/eigs_990.ini.xml
out=$BASE_DIR/out/eigs/eigs_990.out.xml
