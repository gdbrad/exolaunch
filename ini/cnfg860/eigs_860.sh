...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs860.out
...
log=$BASE_DIR/log/eigs/eigs_860.log
in=$BASE_DIR/xml/eigs/eigs_860.ini.xml
out=$BASE_DIR/out/eigs/eigs_860.out.xml
