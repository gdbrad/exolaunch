...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs300.out
...
log=$BASE_DIR/log/eigs/eigs_300.log
in=$BASE_DIR/xml/eigs/eigs_300.ini.xml
out=$BASE_DIR/out/eigs/eigs_300.out.xml
