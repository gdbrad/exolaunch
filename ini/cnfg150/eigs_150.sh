...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs150.out
...
log=$BASE_DIR/log/eigs/eigs_150.log
in=$BASE_DIR/xml/eigs/eigs_150.ini.xml
out=$BASE_DIR/out/eigs/eigs_150.out.xml
