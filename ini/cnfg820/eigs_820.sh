...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs820.out
...
log=$BASE_DIR/log/eigs/eigs_820.log
in=$BASE_DIR/xml/eigs/eigs_820.ini.xml
out=$BASE_DIR/out/eigs/eigs_820.out.xml
