...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs560.out
...
log=$BASE_DIR/log/eigs/eigs_560.log
in=$BASE_DIR/xml/eigs/eigs_560.ini.xml
out=$BASE_DIR/out/eigs/eigs_560.out.xml
