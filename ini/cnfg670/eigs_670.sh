...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs670.out
...
log=$BASE_DIR/log/eigs/eigs_670.log
in=$BASE_DIR/xml/eigs/eigs_670.ini.xml
out=$BASE_DIR/out/eigs/eigs_670.out.xml
