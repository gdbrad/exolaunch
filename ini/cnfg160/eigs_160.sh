...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs160.out
...
log=$BASE_DIR/log/eigs/eigs_160.log
in=$BASE_DIR/xml/eigs/eigs_160.ini.xml
out=$BASE_DIR/out/eigs/eigs_160.out.xml
