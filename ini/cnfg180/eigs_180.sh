...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs180.out
...
log=$BASE_DIR/log/eigs/eigs_180.log
in=$BASE_DIR/xml/eigs/eigs_180.ini.xml
out=$BASE_DIR/out/eigs/eigs_180.out.xml
