...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs800.out
...
log=$BASE_DIR/log/eigs/eigs_800.log
in=$BASE_DIR/xml/eigs/eigs_800.ini.xml
out=$BASE_DIR/out/eigs/eigs_800.out.xml
