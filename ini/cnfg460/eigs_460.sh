...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs460.out
...
log=$BASE_DIR/log/eigs/eigs_460.log
in=$BASE_DIR/xml/eigs/eigs_460.ini.xml
out=$BASE_DIR/out/eigs/eigs_460.out.xml
