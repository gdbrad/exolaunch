...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs640.out
...
log=$BASE_DIR/log/eigs/eigs_640.log
in=$BASE_DIR/xml/eigs/eigs_640.ini.xml
out=$BASE_DIR/out/eigs/eigs_640.out.xml
