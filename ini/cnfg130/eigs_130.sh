...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs130.out
...
log=$BASE_DIR/log/eigs/eigs_130.log
in=$BASE_DIR/xml/eigs/eigs_130.ini.xml
out=$BASE_DIR/out/eigs/eigs_130.out.xml
