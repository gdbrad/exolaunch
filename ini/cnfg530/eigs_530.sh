...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs530.out
...
log=$BASE_DIR/log/eigs/eigs_530.log
in=$BASE_DIR/xml/eigs/eigs_530.ini.xml
out=$BASE_DIR/out/eigs/eigs_530.out.xml
