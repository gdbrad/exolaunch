...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs540.out
...
log=$BASE_DIR/log/eigs/eigs_540.log
in=$BASE_DIR/xml/eigs/eigs_540.ini.xml
out=$BASE_DIR/out/eigs/eigs_540.out.xml
