...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs190.out
...
log=$BASE_DIR/log/eigs/eigs_190.log
in=$BASE_DIR/xml/eigs/eigs_190.ini.xml
out=$BASE_DIR/out/eigs/eigs_190.out.xml
