...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs240.out
...
log=$BASE_DIR/log/eigs/eigs_240.log
in=$BASE_DIR/xml/eigs/eigs_240.ini.xml
out=$BASE_DIR/out/eigs/eigs_240.out.xml
