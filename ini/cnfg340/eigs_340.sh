...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs340.out
...
log=$BASE_DIR/log/eigs/eigs_340.log
in=$BASE_DIR/xml/eigs/eigs_340.ini.xml
out=$BASE_DIR/out/eigs/eigs_340.out.xml
