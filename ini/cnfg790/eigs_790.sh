...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs790.out
...
log=$BASE_DIR/log/eigs/eigs_790.log
in=$BASE_DIR/xml/eigs/eigs_790.ini.xml
out=$BASE_DIR/out/eigs/eigs_790.out.xml
