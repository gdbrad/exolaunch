...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs230.out
...
log=$BASE_DIR/log/eigs/eigs_230.log
in=$BASE_DIR/xml/eigs/eigs_230.ini.xml
out=$BASE_DIR/out/eigs/eigs_230.out.xml
