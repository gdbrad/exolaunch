...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs500.out
...
log=$BASE_DIR/log/eigs/eigs_500.log
in=$BASE_DIR/xml/eigs/eigs_500.ini.xml
out=$BASE_DIR/out/eigs/eigs_500.out.xml
