...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs270.out
...
log=$BASE_DIR/log/eigs/eigs_270.log
in=$BASE_DIR/xml/eigs/eigs_270.ini.xml
out=$BASE_DIR/out/eigs/eigs_270.out.xml
