...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs350.out
...
log=$BASE_DIR/log/eigs/eigs_350.log
in=$BASE_DIR/xml/eigs/eigs_350.ini.xml
out=$BASE_DIR/out/eigs/eigs_350.out.xml
