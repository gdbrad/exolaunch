...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs760.out
...
log=$BASE_DIR/log/eigs/eigs_760.log
in=$BASE_DIR/xml/eigs/eigs_760.ini.xml
out=$BASE_DIR/out/eigs/eigs_760.out.xml
