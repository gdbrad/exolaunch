...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs810.out
...
log=$BASE_DIR/log/eigs/eigs_810.log
in=$BASE_DIR/xml/eigs/eigs_810.ini.xml
out=$BASE_DIR/out/eigs/eigs_810.out.xml
