...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs920.out
...
log=$BASE_DIR/log/eigs/eigs_920.log
in=$BASE_DIR/xml/eigs/eigs_920.ini.xml
out=$BASE_DIR/out/eigs/eigs_920.out.xml
