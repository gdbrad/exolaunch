...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs490.out
...
log=$BASE_DIR/log/eigs/eigs_490.log
in=$BASE_DIR/xml/eigs/eigs_490.ini.xml
out=$BASE_DIR/out/eigs/eigs_490.out.xml
