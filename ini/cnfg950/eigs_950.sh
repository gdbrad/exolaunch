...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs950.out
...
log=$BASE_DIR/log/eigs/eigs_950.log
in=$BASE_DIR/xml/eigs/eigs_950.ini.xml
out=$BASE_DIR/out/eigs/eigs_950.out.xml
