...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs120.out
...
log=$BASE_DIR/log/eigs/eigs_120.log
in=$BASE_DIR/xml/eigs/eigs_120.ini.xml
out=$BASE_DIR/out/eigs/eigs_120.out.xml
