...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs980.out
...
log=$BASE_DIR/log/eigs/eigs_980.log
in=$BASE_DIR/xml/eigs/eigs_980.ini.xml
out=$BASE_DIR/out/eigs/eigs_980.out.xml
