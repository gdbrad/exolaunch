...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs410.out
...
log=$BASE_DIR/log/eigs/eigs_410.log
in=$BASE_DIR/xml/eigs/eigs_410.ini.xml
out=$BASE_DIR/out/eigs/eigs_410.out.xml
