...
#SBATCH -t 400
#SBATCH --gres=gpu:4
#SBATCH -o /p/scratch/exotichadrons/exolauncher/res/eigs910.out
...
log=$BASE_DIR/log/eigs/eigs_910.log
in=$BASE_DIR/xml/eigs/eigs_910.ini.xml
out=$BASE_DIR/out/eigs/eigs_910.out.xml
